...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6857918785:AAE8O7lynXOFUYKjPXSooWkBzw89PnwpFjE")
    API_ID = int(os.environ.get("API_ID", "23449041"))
    API_HASH = os.environ.get("API_HASH", "22263bf0807d45f0fc9bac99471fec1b")
    ...
    GROUPS = os.environ.get('GROUPS', '-1002062552199').split(',')
    for i in range(len(GROUPS)):
        GROUPS[i] = int(GROUPS[i])

    LOG_CH = -1002016745858
...
if __name__ == "__main__":
    ...
    async def main():
        await PRO.start()
        # h = await PRO.get_chat_member(chat_id= int(-1002016745858), user_id=6585878012)
        # print(h)
